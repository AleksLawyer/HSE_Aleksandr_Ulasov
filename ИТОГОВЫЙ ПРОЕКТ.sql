...
INSERT INTO `case_outcomes` VALUES (5,'2024-06-30',2,'Детали определения по делу'),(6,'2024-05-20',1,'Иск удовлетворен частично');
...
CREATE TABLE `case_participants_individuals` (
  ...
  PRIMARY KEY (`case_id`,`participant_id`,`outcome_type_id`),
  KEY `role_id` (`role_id`),
  KEY `outcome_type_id` (`outcome_type_id`),
  ...
  CONSTRAINT `case_participants_individuals_ibfk_3` FOREIGN KEY (`outcome_type_id`) REFERENCES `outcome_types` (`id`) ON DELETE CASCADE,
...
INSERT INTO `case_participants_individuals` VALUES (6,3,1,1);
...
CREATE TABLE `case_participants_legal_entities` (
  ...
  CONSTRAINT `case_participants_legal_entities_ibfk_3` FOREIGN KEY (`outcome_type_id`) REFERENCES `outcome_types` (`id`) ON DELETE CASCADE,
...
INSERT INTO `case_participants_legal_entities` VALUES (5,1,2,1),(5,2,1,2);
...
INSERT INTO `court_cases` VALUES (5,'5678/2024',2,'2024-02-15','2024-06-30',2),(6,'9012/2023',2,'2024-03-10','2024-05-20',1);
...
INSERT INTO `documents` VALUES (11,5,'Протокол судебного заседания','2024-03-15','2024-12-16 12:05:53','Текст протокола'),(12,6,'Решение по делу','2024-03-15','2024-12-16 12:05:53','Текст решения'),(13,5,'Решение суда','2024-06-10','2024-12-16 12:15:32','Судья: Петрова Елена Сергеевна\nРешение: Отказать\nДетали: Детали определения по делу');
...
INSERT INTO `individuals` VALUES (1,'Иванов','Иван','Иванович','1234567890','1990-01-01','new_email@example.com',1),(2,'Петрова','Елена','Сергеевна','9876543210','1985-05-10','+7 (910) 123-45-67',1),(3,'Сидоров','Петр','Алексеевич','1112223334','1982-12-15','sidorov@example.com',1);
...
-- Dump completed on 2024-12-16 16:18:29
